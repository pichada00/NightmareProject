...
public class @StarterAssetss : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @StarterAssetss()
    {
    ...
    {
        private @StarterAssetss m_Wrapper;
        public PlayerActions(@StarterAssetss wrapper) { m_Wrapper = wrapper; }
